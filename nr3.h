...
typedef const std::vector<char> VecChar_I;
typedef std::vector<char> VecChar, VecChar_O, VecChar_IO;

typedef const std::vector<double> VecDoub_I;
typedef std::vector<double> VecDoub, VecDoub_O, VecDoub_IO;

typedef const std::vector<bool> VecBool_I;
typedef std::vector<bool> VecBool, VecBool_O, VecBool_IO;
